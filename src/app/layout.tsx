...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className="fixed inset-x-0 top-0 z-20 h-14 border-b border-[#DCE6DB] bg-[#F5FAF4]/95 backdrop-blur md:hidden" />
        <div className="flex min-h-screen">
          <Sidebar />
          <main className="flex-1 overflow-auto">
            <div className="mx-auto max-w-7xl px-3 py-4 pt-16 sm:px-4 sm:py-6 sm:pt-16 lg:px-8 lg:pt-6">
              <div className="fixed top-3 right-3 z-50 md:static md:mb-6 md:flex md:justify-end">
                <UserProfile
